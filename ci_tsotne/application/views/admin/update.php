...
<form method="post" action="<?php echo base_url().'admin/saveupdate/'?>" enctype="multipart/form-data">

    <table width="600" align="center" border="10"   style="margin: 0 auto; background-color: #466675; color:#FFFFFF; font-size: 18px;">
            <tr>
                <td align="center" bgcolor="brown" colspan="2" style="color:#FFFFFF; background-color: #000000;"><h1>Insert New post here</h1></td>
            </tr>
                <tr>
                <td  align="right"><center>Post id:</center></td>
                <td><input type="text" name="uid" value= <?php echo $rows->id; ?>></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="file" name="image" value= <?php echo $rows->img; ?>></td>
            </tr>
            <tr>
